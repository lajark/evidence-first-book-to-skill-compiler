# Book2Skill · Evidence-First Skill Compiler
...
> 中文文档：[README.md](README.md) · Package/CLI name: `book2skill`

[![Python](https://img.shields.io/badge/python-3.11%2B-blue.svg)](https://www.python.org/downloads/)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Tests](https://img.shields.io/badge/tests-996%20passed%20%2F%201%20skipped-brightgreen.svg)](#testing-and-quality)
...
- [README.md](README.md) — Chinese guide
...
Suggested GitHub display name: **Evidence-First Skill Compiler**. Suggested repository slug: `evidence-first-skill-compiler`. Keep the Python package and CLI names as `book2skill` for compatibility.
