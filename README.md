...
> English documentation: [README.en.md](README.en.md) · Package/CLI name: `book2skill`

[![Python](https://img.shields.io/badge/python-3.11%2B-blue.svg)](https://www.python.org/downloads/)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Tests](https://img.shields.io/badge/tests-996%20passed%20%2F%201%20skipped-brightgreen.svg)](#测试与质量)
...
建议 GitHub 展示名：**Evidence-First Skill Compiler**；建议仓库 slug：`evidence-first-skill-compiler`。保留 Python 包名和 CLI 名 `book2skill`，兼顾公开项目辨识度与现有安装兼容性。
