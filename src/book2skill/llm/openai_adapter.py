...
def _build_chunk_prompt(
    ...
    return (
        ...
        "candidates instead of a generic summary. Emit concrete scenarios, worked "
        "examples or situational responses as separate `case` candidates, distinct "
        "from the ordered workflow. When the source defines a structured artifact "
...
def _build_synthesis_prompt(
    ...
    return (
        ...
        "scenarios or worked examples as `case` units (not techniques) so "
        "situational responses stay distinct from the ordered workflow. When the "
