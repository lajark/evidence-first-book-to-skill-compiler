...
#   Original file: book_to_skill/parsers/pdf.py
...
"""PDF text extraction backends: pdftotext, pypdf, pdfminer, and docling.

Each backend is optional; callers should try them in order and use the first
that returns non-empty text.
"""
