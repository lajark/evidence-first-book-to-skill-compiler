...
#   Original file: book_to_skill/parsers/html.py
...
#   - Adjusted import to use the vendored `text` module within this package.
#   - No functional changes.

"""HTML → plain text extraction with an optional BeautifulSoup backend."""
